...
public class MovieJSONDAOTest {
	...
	public void setupMovieJSONDAO () throws IOException {
		...
		testMovies[1] = new Movie(105, "Star Wars: Episode V – The Empire Strikes Back", "death/star/2/plans.jpg", 124, "PG", 1980);
		testMovies[2] = new Movie(106, "Star Wars: Episode VI - Return of the Jedi", "death/star/3/plans.jpg", 131, "PG", 1983);
